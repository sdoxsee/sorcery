...
Rails.application.config.sorcery.submodules = [:external, :core, :remember_me]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.twitter.key = "lmnbFS7Kw3DYNNEZbSZHQ"
  config.twitter.secret = "dybKMjkiHEIUzHV3xyYM5tXnX6JsgdhrqNQwlPXIXU"
  config.twitter.callback_url = "http://0.0.0.0:3000/oauth/callback?provider=twitter"
  config.twitter.user_info_mapping = {:username => "screen_name"}

  config.facebook.key = "231610570272821"
  config.facebook.secret = "79bd109f434052f57f4dc7ba81b3b4ae"
  config.facebook.callback_url = "http://0.0.0.0:3000/oauth/callback?provider=facebook"
  config.facebook.user_info_mapping = {:username => "username", :email => "email", :name => 'name', :location => 'location'}
